      ...
      <main className="relative min-h-screen overflow-hidden flex items-center justify-center p-4 pt-24 pb-20">
        ...
        <div className="relative z-10 w-full max-w-md">
          ...
          {activeRequests.length === 0 && (
            ...
            >
              <Card className="rounded-3xl shadow-2xl border border-white/10 bg-card/60 backdrop-blur-xl mx-auto w-full max-w-md glass-effect">
                ...
                <CardContent className="p-6">
                  <form className="space-y-4" onSubmit={handleSubmit}>
                    <div className="space-y-2">
                      ...
                      >
                        <SelectTrigger className="rounded-2xl h-12 px-4 gap-2 text-lg bg-background/40 border border-white/10 hover:border-white/20 transition-all">
                          <SelectValue placeholder={t('buy.select_crypto')} />
                        </SelectTrigger>
                        <SelectContent className="bg-background/10 border border-white/10 glass-effect">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        className="h-12 rounded-2xl bg-background/40 border border-white/10 focus:border-purple-500 transition-all text-foreground"
                      />
                    ...
                    <Button
                      type="submit"
                      className="w-full h-14 text-lg rounded-2xl bg-gradient-to-r from-purple-600 via-purple-500 to-purple-700 hover:from-purple-700 hover:via-purple-600 hover:to-purple-800 shadow-lg hover:shadow-xl hover:shadow-purple-500/50 transition-all font-semibold mt-4"
          ...
          {hasActiveRequest && activeRequests.length > 0 && (
            <motion.div
              ...
              transition={{ duration: 0.5, delay: 0.1 }}
            >
              <Card className="rounded-3xl shadow-2xl border border-white/10 bg-card/60 backdrop-blur-xl mt-6 mx-auto w-full max-w-md glass-effect">
                <CardHeader className="text-center">
                    ...
                    <div key={request.request_id} className="bg-background/40 rounded-2xl p-4 border border-white/10 mb-4 last:mb-0">
                      ...
                      {request.receipt_image && request.status === 'processing' && (
                        <Button
                          ...
                          className="w-full mt-3 h-12 rounded-2xl bg-gradient-to-r from-purple-600 via-purple-500 to-purple-700 hover:from-purple-700 hover:via-purple-600 hover:to-purple-800 shadow-lg hover:shadow-xl hover:shadow-purple-500/50 transition-all font-semibold"
                          disabled={isSubmitting}
                        >
